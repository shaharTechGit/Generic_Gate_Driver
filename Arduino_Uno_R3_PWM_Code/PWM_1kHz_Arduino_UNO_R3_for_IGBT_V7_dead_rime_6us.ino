...
const int duty_us = 487;                  // ON time (pulse width) in microseconds (~48.7% duty cycle)
const int dead_time_us = 6;                // Dead time between D9 falling and D10 rising [µs]
